  ...
  return (
    <div className="App">
      <Route exact path='/'>
       <Home/>
       <div class="container">
<svg class="ghost" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
...
<path fill="#FCEFED" stroke="#FEEBE6" stroke-miterlimit="10" d="M116.279,55.814c-0.021-0.286-2.323-28.744-30.221-41.012
  ...
  <p class="shadowFrame"><svg version="1.1" class="shadow" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xlink="http://www.w3.org/1999/xlink" x="61px" y="20px"
	 width="122.436px" height="39.744px" viewBox="0 0 122.436 39.744" enable-background="new 0 0 122.436 39.744"
	 space="preserve">
<ellipse fill="#15172b" cx="61.128" cy="19.872" rx="49.25" ry="8.916"/>
    </svg></p>
</div>
    ...
    <Route exact path='(/AddContact|/EditContact)'>
      <Home/>
      <AddEdit/>
    </Route>
